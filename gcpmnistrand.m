...
system(['echo gcpmnistrand MNIST-s shuffled rand, 2, minibatch_history_CB >> done'  ]);

F_main_classifier(1, 'MNIST-s', 'randnegativenonstationary','shuffled', 2, 'full_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, MNIST-s, randnegativenonstationary,shuffled, 2, full_history_CB, 1000, gcp-gpu, 20000)')
system(['echo gcpmnistrand MNIST-s shuffled rand, 2, full_history_CB >> done'  ]);

F_main_classifier(1, 'MNIST-s', 'randnegativenonstationary','shuffled', 2, 'multimode_minibatch_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, MNIST-s, randnegativenonstationary,shuffled, 2, multimode_minibatch_history_CB, 1000,gcp-gpu, 20000)')
system(['echo gcpmnistrand MNIST-s shuffled rand, 2, multimode_minibatch_history_CB >> done'  ]);

F_main_classifier(1, 'MNIST-s', 'randnegativenonstationary','shuffled', 2, 'multimode_full_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, MNIST-s, randnegativenonstationary,shuffled, 2, multimode_full_history_CB, 1000,gcp-gpu, 20000)')
system(['echo gcpmnistrand MNIST-s shuffled rand, 2, multimode_full_history_CB >> done'  ]);
