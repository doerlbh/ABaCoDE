...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 1, baseline >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 1, universal_embedding >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 2, minibatch_embedding >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 2, online_embedding >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 2, minibatch_history_CB >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 2, full_history_CB >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 2, multimode_minibatch_history_CB >> done'  ]);
...
system(['echo gcpmnistrandstat MNIST-s shuffled randstat, 2, multimode_full_history_CB >> done'  ]);
