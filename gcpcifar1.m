...
F_main_classifier_local(1, 'CIFAR-10', 'nonstationary','unshuffled', 8, 'multimode_minibatch_history_CB', 1000, 'americano', 10000)
...
F_main_classifier_local(1, 'CIFAR-10', 'nonstationary','unshuffled', 8, 'multimode_full_history_CB', 1000, 'americano', 10000)
