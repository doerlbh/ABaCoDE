...
F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 1, 'baseline', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 1, baseline, 1000,gcp-gpu, 20000)')
...
F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 2, 'multimode_minibatch_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 2, multimode_minibatch_history_CB, 1000,gcp-gpu, 20000)')
system(['echo CIFAR-10 shuffled, 2, multimode_minibatch_history_CB >> done'  ]);

F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 2, 'multimode_full_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 2, multimode_full_history_CB, 1000,gcp-gpu, 20000)')
...
F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 4, 'multimode_minibatch_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 4, multimode_minibatch_history_CB, 1000,gcp-gpu, 20000)')
system(['echo CIFAR-10 shuffled, 4, multimode_minibatch_history_CB >> done'  ]);

F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 4, 'multimode_full_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 4, multimode_full_history_CB, 1000,gcp-gpu, 20000)')
...
F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 8, 'multimode_minibatch_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 8, multimode_minibatch_history_CB, 1000,gcp-gpu, 20000)')
system(['echo CIFAR-10 shuffled, 8, multimode_minibatch_history_CB >> done'  ]);

F_main_classifier(1, 'CIFAR-10', 'nonstationary','shuffled', 8, 'multimode_full_history_CB', 1000, 'gcp-gpu', 20000)
disp('F_main_classifier(1, CIFAR-10, nonstationary,shuffled, 8, multimode_full_history_CB, 1000,gcp-gpu, 20000)')
